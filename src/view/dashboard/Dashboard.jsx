  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="pt-16 py-10 mx-20 sm:py-20 items-center">
        <div className="grid grid-cols-1 items-center mx-2 sm:grid-cols-2 sm:px-8 sm:mx-24  lg:grid-cols-3">
          <div className="items-center text-center">
            <p className="text-md text-gray-400 mb-2">Pengguna Terdaftar</p>
            <h1 className="text-black text-4xl font-semibold pb-10 sm:pb-10 lg:pb-0">
              1,234,567
            </h1>
          </div>
          <div className="items-center text-center">
            <p className="text-md text-gray-400 mb-2">Total Produk</p>
            <h1 className="text-black text-4xl font-semibold pb-10 lg:pb-0">
              1,234,567
            </h1>
          </div>
          <div className="items-center text-center">
